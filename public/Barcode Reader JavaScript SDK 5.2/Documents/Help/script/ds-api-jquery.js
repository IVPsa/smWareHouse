...
$(function () {
    ...
    $("#leftmenu li a").click(function (e) {
        try {
            if ($.browser.chrome == true) parent.location.hash = "";
            e.preventDefault();
        }
        catch (e) {
        ...
        var strTarget = "";
        if (typeof ($(this).prop("href")) != "undefined" && $(this).attr("href") != "") {
            strTarget = $(this).prop("href");
            $("#leftmenu li a.current").removeClass("current");
            $(this).addClass("current");
            try {
                if ($.browser.chrome == true) parent.location.hash = "#" + strTarget;
                parent.document.getElementById("win-content").src = strTarget;
            }
            catch (e) {
            }
            return false;
