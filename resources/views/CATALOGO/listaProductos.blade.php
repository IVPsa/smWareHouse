...
<h3 class="text-center display-3">Lista De Productos Registrados</h3>

<div class="container" ng-app="">

  <div class="form-group row">
    <label  for="first_name" class="col-md-2 col-xs-12 col-form-label text-right">LISTADO DE:</label>
    <div class="col-md-10 col-xs-12" >
      <form>
        <select  class="form-control" ng-model="opcion">
              ...
              <div ng-switch-when="PILARES">
                <div class="row">
                  <div class="col-md-12 col-xs-12">
                    <div class="table-responsive" >
                      <table class="table table-bordered table-hover  table-striped" align="center"  id="table">
                        ...
                        <thead class="thead-dark">
                          ...
                          @foreach($listaDePilares as $Pilar)
                        <tr>
                          <td>{{$Pilar->PL_COD}}</td>
                          <td>{{$Pilar->PL_NOMBRE}}</td>
                          <td>{{$Pilar->PL_DESCRIPCION}}</td>
                          <td>{{$Pilar->TP_DESC}}</td>
                          <td>{{$Pilar->PL_N_ARTICULO}}</td>
                          <td>{{$Pilar->PL_UDI01}}</td>
                          <td width="15px" >
                            <a href="{{route('fichaDePilar', $Pilar->PL_COD)}}">
                    ...
                    {{ $listaDePilares->links() }}

                  </div>
                </div>
              </div>

              <div ng-switch-when="IMPLANTES">
                <div class="container"   ng-app="">
                  @csrf
