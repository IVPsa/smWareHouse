...
<head>
    ...
    <script type="text/javascript" src="{{ asset('DBRResources/dynamsoft.barcodereader.config.js')}}"> </script>
    <script type="text/javascript" src="{{ asset('DBRResources/dynamsoft.barcodereader.initiate.js')}}"> </script>
